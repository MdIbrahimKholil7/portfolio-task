    ...
    return (
        <div id='about' className='max-w-[1386px] mx-auto'>
            <div>
                ...
                <div className="hero min-h-[80vh] lg:mt-20 ">
                    <div className="hero-content items-start gap-7 lg:gap-6 xl:gap-40 flex-col justify-between w-full lg:flex-row-reverse">

                        <img src={img} className="lg:max-w-[317px]max-w-[300px] sm:max-w-[440px] h-auto lg:h-[346px] object-cover border-solid border-[8px] border-[#458fd0] rounded-lg  shadow-2xl mx-auto" alt='img' />
